...
ggplot(data = output,
  ...
  scale_fill_manual(values = c("Male" = "darkgreen",
                               "Female" = "red",
                               "white" = "darkgreen",
                               "non_white" = "red",
                               "above_poverty" = "darkgreen",
                               "below_poverty" = "red",
                               "younger" = "darkgreen",
                               "older" = "red")) +
...
plot3 <- ggplot(data = data.frame(table(demographics$income)),
  ...
  geom_bar(stat="identity", width=1) +
  coord_polar("y", start=0) +
  scale_fill_manual(values = c("above_poverty" = "darkgreen",
                               "below_poverty" = "red")) +
  geom_text(aes(label = Var1), position = position_stack(vjust = 0.5)) +
  theme_void() +
  theme(legend.position="none")
...
plot4 <- ggplot(data = data.frame(table(demographics$age)),
  ...
  geom_bar(stat="identity", width=1) +
  coord_polar("y", start=0) +
  scale_fill_manual(values = c("younger" = "darkgreen",
                               "older" = "red")) +
  geom_text(aes(label = Var1), position = position_stack(vjust = 0.5)) +
  theme_void() +
  theme(legend.position="none")
